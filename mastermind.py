...
def create_code():
    ...
    for i in range(4):
        ...
        while value in code:
            value = random.randint(1, 8)  # 8 possible digits
        code[i] = value
    #print(code)    #Activate this print to show answer for easy testing.
    return code
...
def get_answer_input():
    """Gets answer from user and checks if answer is valid"""

    answer = input("Input 4 digit code: ")
    while len(answer) != 4 or answer.isdigit() != True or \
    answer.find("0") != -1 or answer.find("9") != -1:
